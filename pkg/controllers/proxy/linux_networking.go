...
import (
	...
	"github.com/nholuongut/kube-router/v2/pkg/cri"
...
func (ln *linuxNetworking) ipAddrAdd(iface netlink.Link, ip string, nodeIP string, addRoute bool) error {
	...
	// VIP from the host. Please see https://github.com/nholuongut/kube-router/issues/376
	if !addRoute {
		return nil
	}
	...
	// create the source route below. See: https://github.com/nholuongut/kube-router/issues/1698
	if isIPv6 {
